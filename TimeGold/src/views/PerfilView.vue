<template>
    <section class="min-h-screen bg-gradient-to-r from-[#7021D8] to-[#5013A0] py-16 px-6">
        <div class="max-w-4xl mx-auto bg-white rounded-2xl shadow-2xl p-10 border border-purple-200">
            <a href="admin" class="text-purple-800 hover:text-purple-600 flex items-center gap-2 mb-6">
    ...
    data() {
        return {
            ...
            profile: {
                ...
                cro: "CRO-SP 12345",
                email: "maisaamaral206@gmail.com",
                phone: "(14) 99677-2006",
                clinic: "TimeGold",
                address: "Rua das Flores, 245 - São Paulo, SP",
                about: "Maisa Amaral é responsável pela gestão da clínica TimeGold...",
                yearsExperience: 8,
                languages: "Português, Inglês",
                insurances: "OdontoPrev, Bradesco Saúde"
            }
        }
    },
    methods: {
